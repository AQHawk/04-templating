...
Article.prototype.toHtml = function() {
  ...
  rawData.forEach(function(templateObj){
    articles.push(new Article(templateObj));
  });

  articles.forEach(function(newTemplateObj){
$('#template').append(newTemplateObj.toHtml());
